...
"[project]/app/api/admin/lecturers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        ...
        const hashedPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(rawPassword, salt);
        const lecturer = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            name,
            email,
        ...
        console.log(`Subject: Welcome to Smart Attendance Pro`);
        console.log(`Body: Hello ${name}, your lecturer account has been created. Login with:`);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            // Returning credentials here only for demonstration/verification since we don't have real email
            credentials: {
                email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__49517535._.js.map