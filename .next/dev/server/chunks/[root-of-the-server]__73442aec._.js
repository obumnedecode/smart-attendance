...
async function GET() {
    ...
    try {
        const adminExists = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            role: 'ADMIN'
        });
        if (adminExists) {
        ...
        const hashedPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash('pass123admin', salt);
        const admin = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            name: 'Admin User',
            email: 'admin@qr.com',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__73442aec._.js.map